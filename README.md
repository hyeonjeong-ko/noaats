...
- 콘텐츠형 (Netflix, Spotify, YouTube Premium)
  - 활용률, 미활용 비용, 본전 회복 필요 시간
- 혜택형 (쿠팡 WOW, 멤버십 카드)
  - 활용률, 미활용 비용, 본전 회복 필요 절약액
- 용량형 (Google Drive, OneDrive, iCloud)
  - 활용률, 미활용 비용, 본전 회복 필요 용량
- 자동 의사결정 및 생활소비 환산
...
**배포 주소**: https://noaats-ten.vercel.app/
...
본전 회복 필요 시간 = 기대 사용 시간 - 실제 사용 시간 (0 이상만)

예: Netflix 12,900원, 기대 30시간, 실제 35시간
→ 활용률 117%, 시간당 비용 368원, 본전 달성 → 초과 만족
```
...
본전 회복 필요 절약액 = 월 구독료 - 현재 획득 가치 (0 이상만)

예: 쿠팡 4,900원, 혜택 45,500원
→ 활용률 928%, 초과 이득 40,600원, 본전 달성
```
...
미활용 비용 = 월 구독료 × (1 - 활용률)
1GB당 비용 = 월 구독료 / 제공 용량
본전 회복 필요 용량 = 기대 사용량 - 현재 사용량 (0 이상만)

예: Google One 2,900원, 100GB 중 25GB 사용
→ 활용률 25%, 1GB당 29원, 미활용 비용 2,175원, 75GB 추가 사용 필요
```
